...
- The product photo is the spec for how a part looks, not just the drawing. The photo of product 7 shows two empty bowls, so there is no standpipe; the photo of product 1 shows a black collar, a bright steel fork and a grey wheel, so a caster is not one dark lump. When a builder and a photo disagree, the photo wins.
